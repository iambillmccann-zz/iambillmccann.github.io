...
if (document.getElementsByClassName('demo').length > 0) {
  var i = 0;
  var txt = `cargo run
            Compiling project_euler v0.1.0 (/mnt/e/Bill/Documents/GitHubProjects/ProjectEulerRust)
            Finished dev [unoptimized + debuginfo] target(s) in 4.03s
            Running \'target/debug/project_euler\'

            What problem shall I run? Or type 'Q' to quit.
            4
            -----------------------------------------------------------------
            Solution to problem 4 = 906609
            Execution time was 00:00:00:648
            -----------------------------------------------------------------
